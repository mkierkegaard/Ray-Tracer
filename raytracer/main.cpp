...
int main(void)
{
	...
	o = new Sphere(glm::vec3(0, 0, -3), 0.5, glm::vec3(0.25, 0.25, 0.5), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.2, 0.2, 0.2));
	world.addObject(*o);
	...
	o = new Sphere(glm::vec3(world.lightpos1.x, world.lightpos1.y, world.lightpos1.z), 0.5, glm::vec3(1, 1, 1), glm::vec3(1, 1, 1), glm::vec3(0.0, 0.0, 0.0));
	world.addObject(*o);
	...
	o = new Plane(glm::vec3(0.0, -1.0, 0.0), glm::vec3(0.4, 0.0, 0.0), glm::vec3(0.0, 5, 0.0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0));
	world.addObject(*o);

	o = new Plane(glm::vec3(-1.0, 0.0, 0.0), glm::vec3(0.08, 0.4, 0.0), glm::vec3(5, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0));
	world.addObject(*o);

	o = new Plane(glm::vec3(1.0, 0.0, 0.0), glm::vec3(0.3, 0.3, 0.1), glm::vec3(-5, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0));
	world.addObject(*o);
